...
uint8_t si5351_init(Si5351 *self, uint8_t, uint32_t, int32_t);
void si5351_reset(Si5351 *self);
uint8_t si5351_set_freq(Si5351 *self, uint64_t, enum si5351_clock);
uint8_t si5351_set_freq_manual(Si5351 *self, uint64_t, uint64_t,
		enum si5351_clock);
void si5351_set_pll(Si5351 *self, uint64_t, enum si5351_pll);
void si5351_set_ms(Si5351 *self, enum si5351_clock, struct Si5351RegSet,
		uint8_t, uint8_t, uint8_t);
void si5351_output_enable(Si5351 *self, enum si5351_clock, uint8_t);
void si5351_drive_strength(Si5351 *self, enum si5351_clock, enum si5351_drive);
void si5351_update_status(Si5351 *self);
void si5351_set_correction(Si5351 *self, int32_t, enum si5351_pll_input);
int32_t si5351_get_correction(Si5351 *self, enum si5351_pll_input);
void si5351_set_phase(Si5351 *self, enum si5351_clock, uint8_t);
void si5351_pll_reset(Si5351 *self, enum si5351_pll);
void si5351_set_ms_source(Si5351 *self, enum si5351_clock, enum si5351_pll);
void si5351_set_int(Si5351 *self, enum si5351_clock, uint8_t);
void si5351_set_clock_pwr(Si5351 *self, enum si5351_clock, uint8_t);
void si5351_set_clock_invert(Si5351 *self, enum si5351_clock, uint8_t);
void si5351_set_clock_source(Si5351 *self, enum si5351_clock,
		enum si5351_clock_source);
void si5351_set_clock_disable(Si5351 *self, enum si5351_clock,
		enum si5351_clock_disable);
void si5351_set_clock_fanout(Si5351 *self, enum si5351_clock_fanout, uint8_t);
void si5351_set_pll_input(Si5351 *self, enum si5351_pll, enum si5351_pll_input);
void si5351_set_vcxo(Si5351 *self, uint64_t, uint8_t);
void si5351_set_ref_freq(Si5351 *self, uint32_t, enum si5351_pll_input);
#endif /* SI5351_H_ */
