/**
  @page SDR  Audio Playback and Record application

  @verbatim
  ******************************************************************************
  * @file    Audio/SDR/readme.txt 
...
@par Directory contents 
  ...
  - SDR/Src/main.c               Main program
  - SDR/Src/stm32f7xx_it.c       Interrupt handlers
  - SDR/Src/system_stm32f7xx.c   STM32F7xx system source file
  - SDR/Src/usbh_conf.c          Board support package for the USB host library 	
  - SDR/Src/waveplayer.c         Audio play file
  - SDR/Src/waverecorder.c       Audio record file
  - SDR/Src/usbh_diskio.c        USBH FatFS diskio driver source file
  - SDR/Inc/ffconf.h             FAT file system module configuration file   
  - SDR/Inc/main.h               Main program header file
  - SDR/Inc/stm32f7xx_hal_conf.h HAL configuration file
  - SDR/Inc/stm32f7xx_it.h       Interrupt handlers header file
  - SDR/Inc/usbh_conf.h          USB driver Configuration file
  - SDR/Inc/waveplayer.h         Audio play header file
  - SDR/Inc/waverecorder.h       Audio record header file
  - SDR/Inc/usbh_diskio.h        USBH FatFS diskio driver header file
  - SDR/Src/menu.c               GUI menu management functions
  - SDR/Src/explorer.c           AUDIO files search functions
